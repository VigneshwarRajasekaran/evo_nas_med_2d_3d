...
if __name__ == '__main__':
  ...
  cutout = False
  multigpu_num = 1
  medmnist_dataset = 'organmnist3d'
  check_power_consumption = False
  is_medmnist = True
  evaluation_type = 'zero-cost' #Zero Cost or Training
  is_tune= False
  ...
  # Running the algorithm
  ga.mealypy_evolve('de', 15, 10, strategy=4, medmnist_dataset=medmnist_dataset,
                    data_augmentation=False)  # Strategy from 1 to 7

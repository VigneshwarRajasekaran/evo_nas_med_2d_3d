...
if __name__ == '__main__':
    ...
    parser.add_argument('--genotype_name', type=str, default='DARTS_V2',  help="genotype's name to visualize")
    parser.add_argument('--without_view', action='store_true', default=False, help='only save to pdf')
    parser.add_argument('--file_name', type=str, default='3dgenotype' , help='file name to save')
    parser.add_argument('--save_dir', type=Path, default=' ', help='path to save pdf')
    ...
    if genotype_name.endswith('.json'):
        ...
        try:
            genotype = eval(f'genotype.{genotype_name}')
